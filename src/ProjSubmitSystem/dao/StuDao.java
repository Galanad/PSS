    ...
    public List getRecordsDataBySql(String sql) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // 索引是从1开始的
                stuBean.setSno(rs.getString(1));
                stuBean.setSname(rs.getString(2));
                stuBean.setScno(rs.getString(3));
                stuBean.setScode(rs.getString(4));
                stuBean.setSemail(rs.getString(5));
                list.add(stuBean);
            }
        } catch (Exception e) {
            e.printStackTrace();
