    ...
    public List getRecordsDataBySql(String sql) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // 索引是从1开始的
                courseBean.setCno(rs.getString(1));
                courseBean.setCname(rs.getString(2));
                courseBean.setCyear(rs.getString(3));
                courseBean.setCterm(rs.getInt(4));
                courseBean.setScno(rs.getString(5));
                courseBean.setSnum(rs.getInt(6));
                list.add(courseBean);
            }
        } catch (Exception e) {
            e.printStackTrace();
